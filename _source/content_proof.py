...
from common import BRAND_INTRO
...
PROOF_RECORDS = [
    {
        ...
        "limit": "The exporter is written as WYNVN INT CO., LTD, a different name from the manufacturer identified in this website’s brand signature. The relationship between those entities has not been verified. This copy is not presented as proof of origin for a current VietPaw order.",
    },
    {
        ...
        "limit": "The visible copy does not identify the manufacturer behind VietPaw as exporter. A treatment record relates to its named shipment; it does not establish current product safety or coverage of future orders.",
    },
    {
        ...
        "limit": "This is treated as an illustrative specimen, not an issued certificate for VietPaw or its manufacturer. Request the applicable shipment-specific record for your product and destination.",
    },
    {
        ...
        "limit": "The shipper is written as WYNVN INT CO., LTD. It is not presented as evidence that the manufacturer behind VietPaw shipped the goods or that a current order has been released or delivered.",
    },
]
...
def build(root):
    ...
    publish(root, "/proof/", "Proof & Export Document References | VietPaw",
        "View and download supplied export-document examples, read their scope, and request current manufacturer and shipment records for your VietPaw order.",
        ...
        [section("Brand and document scope",
            p(BRAND_INTRO)+table(["Role", "Name used for this website"], [
                ("Commercial / export brand", "VietPaw"), ("Document status", "Historical references and specimen copies")])+
